/*
UnicornHead: Melody Lew, Ariella Katz, Lior Piloschouk, Tom, Ollie, Toothless
APCS
hw20 - External Audit
2021-10-19
*/
...
/*
DISCO:
0. You can indicate the type of value being stored in the variable. For example, "newPin = (short) 9999;" We thought that
  that was interesting.
1. Our conditional statements can be rewritten to contain only an if statements, as opposed to an if and else statement.
