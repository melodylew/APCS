...
2. .parseInt() allows you to convert a non-integer type to an integer.
   
QCC:
0. What is the difference between Integer.parseInt() and Integer.toString()?
1. Can we use i=i+1, i++, and i+=1 interchangeably? In which instance would you use each?
*/
